...
public:
	...
	void setScaledPixel(unsigned x, unsigned y, unsigned scale, uint32_t rgb);
	void setScaledPixel(unsigned x, unsigned y, unsigned scale, uint8_t red, uint8_t green, uint8_t blue);
